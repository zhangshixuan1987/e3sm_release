...
!  end if
   ...
   if (use_subcol_microp) then
      ...
      call subcol_field_avg(iclwpst(:,top_lev:pver),   ngrdcol, lchnk, iclwpst_grid(:,top_lev:pver))
      call subcol_field_avg(cvreffliq(:,top_lev:pver), ngrdcol, lchnk, cvreffliq_grid(:,top_lev:pver))
      call subcol_field_avg(cvreffice(:,top_lev:pver), ngrdcol, lchnk, cvreffice_grid(:,top_lev:pver))
      call subcol_field_avg(mgflxprc(:,top_lev:pver),  ngrdcol, lchnk, mgflxprc_grid(:,top_lev:pver))
      call subcol_field_avg(mgflxsnw(:,top_lev:pver),  ngrdcol, lchnk, mgflxsnw_grid(:,top_lev:pver))
      call subcol_field_avg(qme(:,top_lev:pver),       ngrdcol, lchnk, qme_grid(:,top_lev:pver))
      call subcol_field_avg(nevapr(:,top_lev:pver),    ngrdcol, lchnk, nevapr_grid(:,top_lev:pver))
      call subcol_field_avg(prain(:,top_lev:pver),     ngrdcol, lchnk, prain_grid(:,top_lev:pver))
      call subcol_field_avg(evapsnow(:,top_lev:pver),  ngrdcol, lchnk, evpsnow_st_grid(:,top_lev:pver))

      if (micro_mg_version == 1 .and. micro_mg_sub_version == 0) then
         call subcol_field_avg(am_evp_st(:,top_lev:pver), ngrdcol, lchnk, am_evp_st_grid(:,top_lev:pver))
      end if

      ! Average fields which are not in pbuf
      call subcol_field_avg(qrout(:,top_lev:pver),     ngrdcol, lchnk, qrout_grid(:,top_lev:pver))
      call subcol_field_avg(qsout(:,top_lev:pver),     ngrdcol, lchnk, qsout_grid(:,top_lev:pver))
      call subcol_field_avg(nsout(:,top_lev:pver),     ngrdcol, lchnk, nsout_grid(:,top_lev:pver))
      call subcol_field_avg(nrout(:,top_lev:pver),     ngrdcol, lchnk, nrout_grid(:,top_lev:pver))
      call subcol_field_avg(cld(:,top_lev:pver),       ngrdcol, lchnk, cld_grid(:,top_lev:pver))
      call subcol_field_avg(qcreso(:,top_lev:pver),    ngrdcol, lchnk, qcreso_grid(:,top_lev:pver))
      call subcol_field_avg(melto(:,top_lev:pver),     ngrdcol, lchnk, melto_grid(:,top_lev:pver))
      call subcol_field_avg(mnuccco(:,top_lev:pver),   ngrdcol, lchnk, mnuccco_grid(:,top_lev:pver))
      call subcol_field_avg(mnuccto(:,top_lev:pver),   ngrdcol, lchnk, mnuccto_grid(:,top_lev:pver))
      call subcol_field_avg(bergo(:,top_lev:pver),     ngrdcol, lchnk, bergo_grid(:,top_lev:pver))
      call subcol_field_avg(homoo(:,top_lev:pver),     ngrdcol, lchnk, homoo_grid(:,top_lev:pver))
      call subcol_field_avg(msacwio(:,top_lev:pver),   ngrdcol, lchnk, msacwio_grid(:,top_lev:pver))
      call subcol_field_avg(psacwso(:,top_lev:pver),   ngrdcol, lchnk, psacwso_grid(:,top_lev:pver))
      call subcol_field_avg(bergso(:,top_lev:pver),    ngrdcol, lchnk, bergso_grid(:,top_lev:pver))
      call subcol_field_avg(cmeiout(:,top_lev:pver),   ngrdcol, lchnk, cmeiout_grid(:,top_lev:pver))
      call subcol_field_avg(qireso(:,top_lev:pver),    ngrdcol, lchnk, qireso_grid(:,top_lev:pver))
      call subcol_field_avg(prcio(:,top_lev:pver),     ngrdcol, lchnk, prcio_grid(:,top_lev:pver))
      call subcol_field_avg(praio(:,top_lev:pver),     ngrdcol, lchnk, praio_grid(:,top_lev:pver))
      call subcol_field_avg(icwmrst(:,top_lev:pver),   ngrdcol, lchnk, icwmrst_grid(:,top_lev:pver))
      call subcol_field_avg(icimrst(:,top_lev:pver),   ngrdcol, lchnk, icimrst_grid(:,top_lev:pver))
      call subcol_field_avg(liqcldf(:,top_lev:pver),   ngrdcol, lchnk, liqcldf_grid(:,top_lev:pver))
      call subcol_field_avg(icecldf(:,top_lev:pver),   ngrdcol, lchnk, icecldf_grid(:,top_lev:pver))
      call subcol_field_avg(icwnc(:,top_lev:pver),     ngrdcol, lchnk, icwnc_grid(:,top_lev:pver))
      call subcol_field_avg(icinc(:,top_lev:pver),     ngrdcol, lchnk, icinc_grid(:,top_lev:pver))
      call subcol_field_avg(state_loc%pdel(:,top_lev:pver), ngrdcol, lchnk, pdel_grid(:,top_lev:pver))
      call subcol_field_avg(prao(:,top_lev:pver),      ngrdcol, lchnk, prao_grid(:,top_lev:pver))
      call subcol_field_avg(prco(:,top_lev:pver),      ngrdcol, lchnk, prco_grid(:,top_lev:pver))

      call subcol_field_avg(state_loc%q(:,top_lev:pver,ixnumliq), ngrdcol, lchnk, nc_grid(:,top_lev:pver))
      call subcol_field_avg(state_loc%q(:,top_lev:pver,ixnumice), ngrdcol, lchnk, ni_grid(:,top_lev:pver))

      if (micro_mg_version > 1) then
         call subcol_field_avg(cldmax(:,top_lev:pver),     ngrdcol, lchnk, cldmax_grid(:,top_lev:pver))

         call subcol_field_avg(state_loc%q(:,top_lev:pver,ixrain),    ngrdcol, lchnk, qr_grid(:,top_lev:pver))
         call subcol_field_avg(state_loc%q(:,top_lev:pver,ixnumrain), ngrdcol, lchnk, nr_grid(:,top_lev:pver))
         call subcol_field_avg(state_loc%q(:,top_lev:pver,ixsnow),    ngrdcol, lchnk, qs_grid(:,top_lev:pver))
         call subcol_field_avg(state_loc%q(:,top_lev:pver,ixnumsnow), ngrdcol, lchnk, ns_grid(:,top_lev:pver))
      end if
   ...
   if (use_subcol_microp) then
      ...
      call subcol_field_avg(cldo(:,top_lev:pver),        ngrdcol, lchnk, cldo_grid(:,top_lev:pver))
      call subcol_field_avg(mgmrprc(:,top_lev:pver),     ngrdcol, lchnk, mgmrprc_grid(:,top_lev:pver))
      call subcol_field_avg(mgmrsnw(:,top_lev:pver),     ngrdcol, lchnk, mgmrsnw_grid(:,top_lev:pver))
      call subcol_field_avg(wsedl(:,top_lev:pver),       ngrdcol, lchnk, wsedl_grid(:,top_lev:pver))
      call subcol_field_avg(cc_t(:,top_lev:pver),        ngrdcol, lchnk, cc_t_grid(:,top_lev:pver))
      call subcol_field_avg(cc_qv(:,top_lev:pver),       ngrdcol, lchnk, cc_qv_grid(:,top_lev:pver))
      call subcol_field_avg(cc_ql(:,top_lev:pver),       ngrdcol, lchnk, cc_ql_grid(:,top_lev:pver))
      call subcol_field_avg(cc_qi(:,top_lev:pver),       ngrdcol, lchnk, cc_qi_grid(:,top_lev:pver))
      call subcol_field_avg(cc_nl(:,top_lev:pver),       ngrdcol, lchnk, cc_nl_grid(:,top_lev:pver))
      call subcol_field_avg(cc_ni(:,top_lev:pver),       ngrdcol, lchnk, cc_ni_grid(:,top_lev:pver))
      call subcol_field_avg(cc_qlst(:,top_lev:pver),     ngrdcol, lchnk, cc_qlst_grid(:,top_lev:pver))
      call subcol_field_avg(iciwpst(:,top_lev:pver),     ngrdcol, lchnk, iciwpst_grid(:,top_lev:pver))
      call subcol_field_avg(icswp(:,top_lev:pver),       ngrdcol, lchnk, icswp_grid(:,top_lev:pver))
      call subcol_field_avg(cldfsnow(:,top_lev:pver),    ngrdcol, lchnk, cldfsnow_grid(:,top_lev:pver))

      if (rate1_cw2pr_st_idx > 0) then
         call subcol_field_avg(rate1ord_cw2pr_st(:,top_lev:pver), ngrdcol, lchnk, rate1ord_cw2pr_st_grid(:,top_lev:pver))
      end if
   ...
   if (use_subcol_microp) then
      call subcol_field_avg(rho(:,top_lev:pver), ngrdcol, lchnk, rho_grid(:,top_lev:pver))
   else
      rho_grid = rho
   end if
