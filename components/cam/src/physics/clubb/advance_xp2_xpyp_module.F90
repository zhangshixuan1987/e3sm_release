    ...
    if ( l_explicit_turbulent_adv_xpyp ) then
      ...
      if ( l_scalar_calc ) then
        ...
        do i = 1, sclr_dim
          ...
          call xpyp_term_ta_pdf_rhs_all( term_wprtpsclrp_explicit(:),       & ! Intent(in)
                                         rho_ds_zt(:),                      & ! Intent(in)
                                         invrs_rho_ds_zm(:),                & ! Intent(in)
                                         gr%invrs_dzm(:),                   & ! Intent(in)
                                         l_upwind_xpyp_ta,                  & ! Intent(in)
        ...
        do i = 1, sclr_dim
          ...
          call xpyp_term_ta_pdf_rhs_all( term_wpthlpsclrp_explicit(:),      & ! Intent(in)
                                         rho_ds_zt(:),                      & ! Intent(in)
                                         invrs_rho_ds_zm(:),                & ! Intent(in)
                                         gr%invrs_dzm(:),                   & ! Intent(in)
                                         l_upwind_xpyp_ta,                  & ! Intent(in)
      ...
      if ( iiPDF_type == iiPDF_ADG1 ) then  
        ...
        if( .not. l_upwind_xpyp_ta .or. l_stats_samp .or. l_godunov_upwind_xpyp_ta ) then
      ...
      elseif ( iiPDF_type == iiPDF_new_hybrid ) then
        ...
        if ( l_upwind_xpyp_ta ) then
           ...
           = zt2zm( pdf_implicit_coefs_terms%coef_wprtp2_implicit )
           term_wprtp2_explicit_zm &
        ...
        if ( l_upwind_xpyp_ta ) then
           ...
           = zt2zm( pdf_implicit_coefs_terms%coef_wpthlp2_implicit )
           term_wpthlp2_explicit_zm &
      ...
      call xpyp_term_ta_pdf_rhs_all( term_wpthlp2_explicit(:),    & ! Intent(in)
        ...
        if ( l_upwind_xpyp_ta ) then
          ...
          = zt2zm( pdf_implicit_coefs_terms%coef_wprtpthlp_implicit )
          term_wprtpthlp_explicit_zm &
        ...
        if ( l_upwind_xpyp_ta ) then
           ...
           = zt2zm( pdf_implicit_coefs_terms%coef_wpup2_implicit )
        ...
        call xpyp_term_ta_pdf_lhs_all( coef_wpup2_implicit(:),    & ! Intent(in)
                                       rho_ds_zt(:),              & ! Intent(in)
                                       invrs_rho_ds_zm(:),        & ! Intent(in)
                                       gr%invrs_dzm(:),           & ! Intent(in)
                                       l_upwind_xpyp_ta,          & ! Intent(in)
        ...
        if ( l_upwind_xpyp_ta ) then
           ...
           = zt2zm( pdf_implicit_coefs_terms%coef_wpvp2_implicit )
        ...
        call xpyp_term_ta_pdf_lhs_all( coef_wpvp2_implicit(:),    & ! Intent(in)
                                       rho_ds_zt(:),              & ! Intent(in)
                                       invrs_rho_ds_zm(:),        & ! Intent(in)
                                       gr%invrs_dzm(:),           & ! Intent(in)
                                       l_upwind_xpyp_ta,          & ! Intent(in)
        ...
        if ( l_scalar_calc ) then
          ...
          do i = 1, sclr_dim, 1
            ...
            if ( l_upwind_xpyp_ta ) then
              ...
              = zt2zm( pdf_implicit_coefs_terms%coef_wpsclrp2_implicit(:,i) )
              term_wpsclrp2_explicit_zm &
            ...
            call xpyp_term_ta_pdf_lhs_all( coef_wpsclrp2_implicit(:),    & ! In
                                           rho_ds_zt(:),                 & ! In
                                           invrs_rho_ds_zm(:),           & ! In
                                           gr%invrs_dzm(:),              & ! In
                                           l_upwind_xpyp_ta,             & ! In
            ...
            ! Calculate the RHS turbulent advection term for <w'sclr'^2>
            call xpyp_term_ta_pdf_rhs_all( term_wpsclrp2_explicit(:),    & ! In
                                           rho_ds_zt(:),                 & ! In
                                           invrs_rho_ds_zm(:),           & ! In
                                           gr%invrs_dzm(:),              & ! In
                                           l_upwind_xpyp_ta,             & ! In
            ...
            if ( l_upwind_xpyp_ta ) then
              ...
              = zt2zm( pdf_implicit_coefs_terms%coef_wprtpsclrp_implicit(:,i) )
              term_wprtpsclrp_explicit_zm &
            ...
            call xpyp_term_ta_pdf_lhs_all( coef_wprtpsclrp_implicit(:),    & ! In
                                           rho_ds_zt(:),                   & ! In
                                           invrs_rho_ds_zm(:),             & ! In
                                           gr%invrs_dzm(:),                & ! In
                                           l_upwind_xpyp_ta,               & ! In
            ...
            call xpyp_term_ta_pdf_rhs_all( term_wprtpsclrp_explicit(:),    & ! In
                                           rho_ds_zt(:),                   & ! In
                                           invrs_rho_ds_zm(:),             & ! In
                                           gr%invrs_dzm(:),                & ! In
                                           l_upwind_xpyp_ta,               & ! In
            ...
            if ( l_upwind_xpyp_ta ) then
              ...
              = zt2zm( pdf_implicit_coefs_terms%coef_wpthlpsclrp_implicit(:,i) )
              term_wpthlpsclrp_explicit_zm &
            ...
            call xpyp_term_ta_pdf_lhs_all( coef_wpthlpsclrp_implicit(:),    & ! In
                                           rho_ds_zt(:),                    & ! In
                                           invrs_rho_ds_zm(:),              & ! In
                                           gr%invrs_dzm(:),                 & ! In
                                           l_upwind_xpyp_ta,                & ! In
            ...
            call xpyp_term_ta_pdf_rhs_all( term_wpthlpsclrp_explicit(:),    & ! In
                                           rho_ds_zt(:),                    & ! In
                                           invrs_rho_ds_zm(:),              & ! In
                                           gr%invrs_dzm(:),                 & ! In
                                           l_upwind_xpyp_ta,                & ! In
