...
# The run case
setenv CASE     TEST7_${MACH}_${COMPSET}_${RESOLUTION}_${CCSMTAG}
# The executable case; if use single executable for multiple runs
setenv COMCASE  TEST7_${MACH}_${COMPSET}_${RESOLUTION}_${CCSMTAG}
...
./xmlchange -file env_run.xml -id SAVE_TIMING_DIR -val '/global/homes/z/zhun/'
